...
class PostList extends React.Component {
                    ...
                    <div className="card">
                        <div className="img-outer">
                            <Link to={"posts/" + post.slug}>
                                <img className="card-img-top" src={post.featured_image_src ? post.featured_image_src : Placeholder} alt="Featured" />
                            </Link>
                        </div>
    ...
    render() {
        ...
        return <div className="posts-container">{this.props.posts.length ? this.renderPosts() : this.renderEmpty()}</div>;
    }
}
